...
export default class DrawerSmallIcon extends Component {
  constructor(props, context) {
    super(props, context);
    this.state = {
      drawerType: 'static',
      openDrawerOffset:( Metrics.WIDTH * 0.7),
            ...
            <View style={styles.drawercontainer}>
              ...
              <Header style={styles.headerSec}>
  							<Left style={styles.left}>
  								<TouchableOpacity  onPress={()=>this.openDrawer()} style={[styles.backArrow, {flexDirection: 'row'}]}>
  							 		<MaterialCommunityIcons name="menu" size={30} color="#fff"/>
                    <View style={styles.alertRed}></View>
  								</TouchableOpacity>
  							</Left>
  							<Body style={styles.body}>
  								<Text style={styles.textTitle}>Drawer Small Icon</Text>
  							</Body>
